...
const Contact = () => {
    return (
        <div className="min-h-screen bg-gradient-to-r from-rose-700/80 via-rose-800/60 to-rose-600/40 pt-32 pb-20 px-6 relative overflow-hidden">
            ...
            <meta name="keywords" content="Encanto, Contact, Natural Hair Care, Organic Shampoo, Herbal Soap, Lice Banishers, Hair Care Products, Eco-friendly, Sustainable Beauty" />
            <meta name="author" content="Mohimanul" />
            <meta name="robots" content="index, follow" />
            <title>Contact Us - Encanto Scented</title>
            <meta property="og:title" content="Contact Us - Encanto Scented" />
            <meta property="og:description" content="Get in touch with Encanto for inquiries, support, or feedback about our natural hair care products." />
